 ...
 */
@Stateless
public class TreatmentattachedfileFacade extends AbstractFacade<Treatmentattachedfile> {
    ...
    public TreatmentattachedfileFacade() {
        super(Treatmentattachedfile.class);
    }
